...
- State: implementation and deployment validation are pending the server build and live initial/no-change checks. No ADC configuration change is part of this phase.
